    ...
    constructor(json: string, scene: BABYLON.Scene) {
        ...
        var onPointerDown = (evt) => {
            ...
            if (this.addingNewCanvas) {
                ...
                this.textCanvases.push(new TextCanvas(JSON.parse('{"id":-1,"text":"Add Title","description":"Add Description","width":0.25,"height":0.05,"position":{"x":' + pickInfo.pickedPoint.x + ',"y":' + pickInfo.pickedPoint.y + ',"z":' + pickInfo.pickedPoint.z + '}}'),
        ...
        scene.registerBeforeRender(() => {
            if (scene.activeCamera)
                for (var i = 0; i < this.textCanvases.length; i++) {
                    ...
                    var pos2 = BABYLON.Vector3.TransformCoordinates(BABYLON.Vector3.FromArray(arr[i], 3), this.textCanvases[i].descriptionMesh.getWorldMatrix());
