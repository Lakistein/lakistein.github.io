...
window.addEventListener('DOMContentLoaded', function () {
    ...
    engine.runRenderLoop(function () {
        sceneMain.render();
        // if (takeSC) {
        //     camera.alpha = -num / 36 * 6;
        //     BABYLON.Tools.CreateScreenshot(engine, camera, { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight });
        //     num++;
        //     if (num == 37) {
        //         num = 0;
        //         takeSC = false;
