...
declare module BABYLON {
    ...
    class Tools {
        ...
        static DumpFramebuffer(width: number, height: number, engine: Engine, name?: string, successCallback?: (data: string) => void): void;
        static CreateScreenshot(engine: Engine, camera: Camera, size: any, name?: string, successCallback?: (data: string) => void): void;
